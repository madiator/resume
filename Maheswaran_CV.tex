...
\end{tabular}
    ...
    Distributed Storage\\Vehicular Networks
    ...
    \begin{list2}
        ...
        \item GPA: 3.93/4
        \item Advisor:  Prof. Bhaskar Krishnamachari
...
\section{\mysidestyle Internship\\Experience}
   ...
   % \textsl{Student} \hfill \textbf{Aug 2006 -- May 2008} \vspace{-3mm}\\\vspace{-1mm}  
    ...
    \textsl{Software Experiences}: TCP/IP, Matlab, \LaTeX, Processing\\
...
%    One of the three Governors of Technology Robotics Society, Gymkhana IIT Kharagpur, 2006-2007. During our tenure, a state of the art Robotics laboratory was conceived, designed and
%established at IIT Kharagpur, which was an entirely student driven initiative.  \vspace{1mm}\\%
%    Conducted Robotics workshops in several Universities like ISM Dhanbad, NIT Rourkela etc in the
%field of Microcontrollers.					              \vspace{1mm}\\%
%   Organizing Head of the Robotix event held every year at IIT Kharagpur, 2005-2006.\vspace{1mm}\\% %__________________________________________________________________________________________________________________
    % Referees
...
%\begin{tabular}{@{}p{7cm}p{7cm}}
%\textbf{Professor Ram Nevatia}       &  \textbf{Professor Axel Pinz}                   \\
%Professor                               &  Associate Professor                       \\
%University of Southern California       &  Graz University of Technology (TU Graz)                      \\
%Los Angeles, California, USA           &  Graz, Austria        \\
...
%
%\begin{tabular}{@{}p{7cm}p{7cm}}
%\textbf{Professor Somnath Sengupta}    &  \textbf{Professor Takako Hashimoto}                    \\
%Professor                              &  Associate Professor                         \\
%Indian Institute of Technology (IIT)    &  Chiba University of Commerce                          \\
%Kharagpur, West Bengal, India         	&  Chiba, Japan            \\
%phone: \textsl{available on request}    &  phone: \textsl{available on request}     \\
%e-mail: \textsl{available on request}   &  e-mail: \textsl{available on request}    \\
%\end{tabular}
